...
def generate_launch_description():
    ...
    empty_world_path = os.path.join(turtlebot_share, 'worlds', 'empty_world.sdf')
    ...
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([gz_sim_share, '/launch/', sim_launch]),
        launch_arguments=[('gz_args', [empty_world_path, ' -r -v 4'])]
    )
    ...
    ros_bridge = Node(
        ...
        arguments=[
            ...
            '/model/waffle_4wheel/scan@sensor_msgs/msg/LaserScan[ignition.msgs.LaserScan',
            # IMU (IGN -> ROS2)
            '/imu@sensor_msgs/msg/Imu[ignition.msgs.IMU',
            '/model/waffle_4wheel/imu@sensor_msgs/msg/Imu[ignition.msgs.IMU',
            # Camera (IGN -> ROS2)
    ...
    # Spawn our 4-wheel robot - make sure using your custom SDF
    ignition_spawn_entity = Node(
            package='ros_ign_gazebo',
            executable='create',
            output='screen',
            arguments=['-entity', 'waffle_4wheel',
                    '-name', 'waffle_4wheel',
    ...
    ld = LaunchDescription([
        ...
        TimerAction(
            ...
            actions=[
                ...
                map_static_tf,
                footprint_to_base_tf , # CRITICAL FIX,
                odom_to_base_footprint  # Add this line
            ]
        ),
